...
contract Auction {
    ...
    function finalize() public {
        ...
        if (judgeAddress != address(0)) {
            require(msg.sender == highestBidderAddress || msg.sender == judgeAddress, "Sender is not the highest bidder or the judge");}
    ...
    function refund() public {
        ...
        assert(highestBidderAddress != address(0));
        require(msg.sender == judgeAddress || msg.sender == sellerAddress, "Sender is not the highest bidder or the judge");
        address payable highestBidder = payable(highestBidderAddress);
        highestBidder.transfer(address(this).balance);

        //payable(highestBidderAddress).transfer(msg.value);
        // TODO Your code here
        //revert("Not yet implemented");
    }
